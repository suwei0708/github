/**
 * @license
 * Video.js 6.5.0 <http://videojs.com/>
...
var Slider = function (_Component) {
  ...
  Slider.prototype.update = function update() {
    ...
    if (this.vertical()) {
      ...
      document.getElementById('volumeVal').innerHTML = (progress * 100).toFixed(0);
      document.getElementById('qjplayer-volumeval').style.display = 'block';
      clearInterval(timer);
      timer = setTimeout(function() {
          document.getElementById('qjplayer-volumeval').style.display = 'none';
      }, 2000);
    } else {
