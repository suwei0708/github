    ...
    $('.vote-btn').on('click', function() {
        if(!$(this).hasClass('vote-btn-dis')) {
            if(voteNum == 0) {
                ...
                // TA的支持者增加头像和昵称
                var html = '<li>'
                               +'<a href="#"><img src="images/sjs-img1.jpg" width="66" height="66" alt=""></a>'
                               +'<p><a href="#">小笼包新增</a></p>'
                           +'</li>';
        ...
        $('#rotate').rotate({
            ...
            callback: function() {
                ...
                if(awards == 3 || awards == 4) {
                    var btnLink = 'http://www.001daima.com/';
                }
                if(awards == 5) {
    ...
    $('.pointer').on('click', function() {
        ...
        switch (item) {
            case 0:
                ...
                break;
            case 1:
                rotateFn(1, 60, '巧匠课堂VIP 3折优惠券', 'qiaojiangyouhuima3zhe');
                break;
            case 2:
                rotateFn(2, 240, '巧匠课堂VIP 5折优惠券', 'qiaojiangyouhuima5zhe');
                break;
            case 3:
                rotateFn(3, 300, '码工助手VIP 3折优惠券', 'magongzhushouyouhuima3zhe');
                break;
            case 4:
                rotateFn(4, 120, '码工助手VIP 5折优惠券', 'magongzhushouyouhuima5zhe');
                break;
            case 5:
                rotateFn(5, 180, '美工云VIP 3折优惠券', 'meigongyunyouhuima3zhe');
                break;
        }
    });
        ...
        if(!$(this).hasClass('btn-dis')) {
            ...
            if(guessNum == 10) {
                ...
                $('.ztpopup-guess').on('click', '.ztpopup-close', function (){
                    window.location.href = '竞猜成功.html';
                });
            }
        }
        else {
